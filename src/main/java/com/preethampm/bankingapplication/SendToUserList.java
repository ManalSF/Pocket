...
public class SendToUserList extends AppCompatActivity implements SendToUserAdapter.OnUserListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myAdapter = new SendToUserAdapter(clientArrayList, this);
    ...
    public void onUserClick(int position) {
        ...
        toUserAccountNo = clientArrayList.get(position).getAccountNumber();
        toUserAccountName = clientArrayList.get(position).getName();
        toUserAccountBalance = clientArrayList.get(position).getBalance();
