...
public class TransactionHistory extends AppCompatActivity {
    ...
    ArrayList<Transfer> transferArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transferArrayList = new ArrayList<Transfer>();
        ...
        myAdapter = new TransactionHistoryAdapter(this, transferArrayList);
    ...
    private void displayDatabaseInfo() {
        ...
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                //*************transferArrayList.add(new Transfer(fromName, ToName, accountBalance, status));
            }
        } finally {
